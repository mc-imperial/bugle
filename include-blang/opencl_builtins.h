...
#define _MATH_UNARY_FUNC_OVERLOAD(NAME, GENTYPE) \
    _CLC_OVERLOAD GENTYPE NAME(GENTYPE x)

#define _MATH_BINARY_FUNC_OVERLOAD(NAME, GENTYPE) \
    _CLC_OVERLOAD GENTYPE NAME(GENTYPE x, GENTYPE y)

#define _MATH_TERNARY_FUNC_OVERLOAD(NAME, GENTYPE) \
    _CLC_OVERLOAD GENTYPE NAME(GENTYPE x, GENTYPE y, GENTYPE z)
...
#define _POWN_MACRO(FLOATGENTYPE, INTGENTYPE) \
    _CLC_OVERLOAD FLOATGENTYPE pown(FLOATGENTYPE x, INTGENTYPE y)
