...
public:
  ...
  virtual std::string getExtractExpr(const std::string &Expr, unsigned UpperBit, unsigned LowerBit) = 0;
  virtual std::string getConcat() = 0;
  virtual std::string getConcatExpr(const std::string &Lhs, const std::string &Rhs) = 0;
  virtual std::string getArithmeticBinary(std::string Name, bugle::Expr::Kind Kind, unsigned Width) = 0;
  virtual std::string getBooleanBinary(std::string Name, bugle::Expr::Kind Kind, unsigned Width) = 0;
...
public:
  ...
  virtual std::string getExtractExpr(const std::string &Expr, unsigned UpperBit, unsigned LowerBit);
  virtual std::string getConcat();
  virtual std::string getConcatExpr(const std::string &Lhs, const std::string &Rhs);
  virtual std::string getArithmeticBinary(std::string Name, bugle::Expr::Kind Kind, unsigned Width);
  virtual std::string getBooleanBinary(std::string Name, bugle::Expr::Kind Kind, unsigned Width);
